...
function AirlineLogo({ code, name }) {
  return (
    <span
      title={name}
      className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-green-300 dark:hover:border-green-500 transition-colors"
    >
      <img
...
export function FlightFooter() {
  return (
    <footer className="bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800 transition-colors" aria-label="Site Footer">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          {/* Column 1 – Contact us */}
          <div>
            <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-200 mb-4">Contact us</h3>
            {/* Business identity */}
            <div className="mb-4 space-y-1.5">
              <p className="text-sm font-bold text-slate-800 dark:text-slate-200">BookingCart Inc.</p>
              <p className="text-xs text-slate-500 flex items-start gap-1.5">
                <svg className="mt-0.5 shrink-0" width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                123 Travel Street, Silicon Valley,<br />CA 94000, USA
              </p>
              <a href="mailto:bookingcart.business@gmail.com" className="text-xs text-slate-500 hover:text-green-600 transition-colors flex items-center gap-1.5">
              ...
              <a href="tel:+18005550199" className="text-xs text-slate-500 hover:text-green-600 transition-colors flex items-center gap-1.5">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <a href="#" aria-label="Facebook"
                className="w-8 h-8 rounded-full border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-green-600 dark:hover:text-green-400 hover:border-green-400 dark:hover:border-green-500 transition-colors">
          ...
          {/* Column 2 – About */}
          <div>
            <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-200 mb-4">About</h3>
            <ul className="space-y-2.5">
              {[
                "About BookingCart",
                "News",
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-900 dark:text-slate-200 mb-4">Other services</h3>
            <ul className="space-y-2.5">
              {[
                "Investor relations",
                "BookingCart Rewards",
      ...
      {/* ── Copyright bar ── */}
      <div className="border-t border-slate-100 dark:border-slate-800 py-4 text-center">
