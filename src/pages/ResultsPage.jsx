 ...
 return (<>
    <div className="bg-green-600 w-full pt-6 pb-20">
      <div className="max-w-[1200px] mx-auto px-6">
        <form data-search-form className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-3 lg:p-4 mt-2 transition-colors">
          {/* Trip Type Options */}
          <div className="flex flex-wrap items-center gap-4 mb-3 text-sm text-slate-700 dark:text-slate-300">
          ...
          <div className="flex flex-col lg:flex-row gap-2 relative">
            ...
            {/* Origin -> Destination */}
            <div className="flex flex-1 border border-slate-300 dark:border-slate-600 rounded-lg overflow-visible relative suggest-container">
              <div className="flex-1 px-3 py-2 border-r border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700/50 transition-colors suggest relative">
                <input id="search-from" name="from" data-airport-input type="text" className="w-full bg-transparent border-none p-0 focus:outline-none text-slate-900 dark:text-white font-semibold placeholder:text-slate-500 dark:text-slate-400" placeholder="From" autoComplete="off" />
                <ul className="suggest__list absolute left-0 top-full mt-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-xl rounded-lg w-[300px] z-50 hidden" role="listbox"></ul>
              </div>
              <button type="button" className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 text-green-600 flex items-center justify-center hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700 z-10 shadow-sm transition-transform hover:scale-105">
                <i className="ph ph-arrows-left-right text-lg"></i>
              </button>
              <div className="flex-1 px-3 py-2 hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700/50 transition-colors suggest relative">
                <input id="search-to" name="to" data-airport-input type="text" className="w-full pl-4 bg-transparent border-none p-0 focus:outline-none text-slate-900 dark:text-white font-semibold placeholder:text-slate-500 dark:text-slate-400" placeholder="To" autoComplete="off" />
                <ul className="suggest__list absolute left-0 top-full mt-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-xl rounded-lg w-[300px] z-50 hidden" role="listbox"></ul>
              </div>
            </div>

            {/* Dates */}
            <div className="flex flex-1 border border-slate-300 dark:border-slate-600 rounded-lg hover:border-slate-400 dark:hover:border-slate-500 transition-colors field group relative" data-return-field>
              <button type="button" data-cal-trigger="depart" className="flex-1 px-3 py-2 text-left cursor-pointer hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700/50 rounded-l-lg border-r border-slate-300 dark:border-slate-600 truncate font-semibold text-slate-900 dark:text-white">
                <span data-cal-label="depart">Depart</span>
              </button>
              <input type="hidden" name="depart" />
              <button type="button" data-cal-trigger="return" className="flex-1 px-3 py-2 text-left cursor-pointer hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700/50 rounded-r-lg truncate font-semibold text-slate-900 dark:text-white">
            ...
            {/* Passengers & Cabin */}
            <div className="flex-1 border border-slate-300 dark:border-slate-600 rounded-lg dropdown relative flex flex-row items-center cursor-pointer hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700/50" data-dropdown>
              <button className="w-full flex items-center gap-2 text-left px-3 py-2 control" type="button" data-dropdown-trigger data-passengers-trigger>
                <i className="ph ph-user text-lg text-slate-500 dark:text-slate-400 shrink-0"></i>
                <span className="font-semibold text-slate-900 dark:text-white truncate flex-1" data-passengers-summary>1 adult - Economy</span>
                <i className="ph ph-caret-down text-sm text-slate-400"></i>
              </button>
              <input type="hidden" name="passengers" value="" />
              <div className="dropdown__panel absolute top-full left-0 mt-1 w-[320px] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl z-50 hidden p-4" role="dialog">
                <div data-passengers className="space-y-4">
                  <div className="flex justify-between items-center counter">
                    ...
                    <div className="flex items-center gap-3 counter__controls">
                      <button className="w-8 h-8 rounded-full border border-slate-200 dark:border-slate-600 flex items-center justify-center text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors" type="button" data-minus="adults"><i className="ph ph-minus"></i></button>
                      <span className="font-medium w-4 text-center kpi dark:text-slate-200" data-count="adults">1</span>
                      <button className="w-8 h-8 rounded-full border border-slate-200 dark:border-slate-600 flex items-center justify-center text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors" type="button" data-plus="adults"><i className="ph ph-plus"></i></button>
                    </div>
                  </div>
                  <div className="flex justify-between items-center counter">
                    <div className="counter__meta">
                    ...
                    <div className="flex items-center gap-3 counter__controls">
                      <button className="w-8 h-8 rounded-full border border-slate-200 dark:border-slate-600 flex items-center justify-center text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors" type="button" data-minus="children"><i className="ph ph-minus"></i></button>
                      <span className="font-medium w-4 text-center kpi dark:text-slate-200" data-count="children">0</span>
                      <button className="w-8 h-8 rounded-full border border-slate-200 dark:border-slate-600 flex items-center justify-center text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors" type="button" data-plus="children"><i className="ph ph-plus"></i></button>
                    </div>
                  </div>
                  <div className="flex justify-between items-center counter">
                    <div className="counter__meta">
                    ...
                    <div className="flex items-center gap-3 counter__controls">
                      <button className="w-8 h-8 rounded-full border border-slate-200 dark:border-slate-600 flex items-center justify-center text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors" type="button" data-minus="infants"><i className="ph ph-minus"></i></button>
                      <span className="font-medium w-4 text-center kpi dark:text-slate-200" data-count="infants">0</span>
                      <button className="w-8 h-8 rounded-full border border-slate-200 dark:border-slate-600 flex items-center justify-center text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors" type="button" data-plus="infants"><i className="ph ph-plus"></i></button>
                    </div>
                  </div>
                  <div className="pt-3 mt-1 border-t border-slate-100 dark:border-slate-700">
                    <select className="w-full bg-slate-50 dark:bg-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-600 rounded-lg text-sm font-semibold p-2.5 focus:outline-none focus:border-green-600 control select" name="cabin">
          ...
          <div id="cal-popup" className="cal-popup hidden absolute z-50 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-2xl rounded-xl p-4 mt-2 transition-colors">
            <div className="cal-header flex justify-between mb-2">
              ...
              <span className="cal-title font-bold text-slate-800 dark:text-slate-100" data-cal-title></span>
    ...
    <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 -mt-16 relative z-10 mx-auto max-w-[1200px] shadow-sm rounded-t-xl overflow-hidden flex items-stretch transition-colors">
      <button className="w-12 flex items-center justify-center bg-white dark:bg-slate-800 hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700 text-slate-400 border-r border-slate-200 dark:border-slate-700 transition-colors">
      ...
      <button className="w-12 flex items-center justify-center bg-white dark:bg-slate-800 hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700 text-slate-400 border-l border-slate-200 dark:border-slate-700 transition-colors">
        <i className="ph ph-caret-right text-xl"></i>
      </button>
      <button className="px-4 flex flex-col items-center justify-center bg-white dark:bg-slate-800 hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-700 text-green-600 dark:text-green-500 border-l border-slate-200 dark:border-slate-700 transition-colors gap-0.5">
    ...
    <main className="flex-grow max-w-[1200px] mx-auto px-6 py-8" data-results>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <aside className="lg:col-span-3 space-y-6 hidden lg:block" data-results-filters>
          ...
          {/* Recommended Group */}
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100 mb-3">Recommended</h3>
            <div className="space-y-2.5">
              <label className="flex items-center gap-3 cursor-pointer group">
                <input type="checkbox" name="stops" value="0" className="w-4 h-4 rounded border-slate-300 accent-green-600" />
                <span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:text-slate-100 dark:group-hover:text-white flex-1 flex items-center gap-2"><i className="ph ph-airplane text-slate-400"></i> Nonstop</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group">
                <input type="checkbox" className="w-4 h-4 rounded border-slate-300 accent-green-600" />
                <span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:text-slate-100 dark:group-hover:text-white flex-1 flex items-center gap-2"><i className="ph ph-suitcase-rolling text-slate-400"></i> Checked baggage included</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer group">
                <input type="checkbox" className="w-4 h-4 rounded border-slate-300 accent-green-600" />
                <span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:text-slate-100 dark:group-hover:text-white flex-1 flex items-center gap-2"><i className="ph ph-eye-slash text-slate-400"></i> Hide budget airlines</span>
              </label>
          ...
          {/* Alliance */}
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100 mb-3">Alliance</h3>
            <div className="space-y-2.5">
              <label className="flex justify-between items-center cursor-pointer group">
                <div className="flex items-center gap-3">
                  <input type="checkbox" className="w-4 h-4 rounded border-slate-300 accent-green-600" />
                  <span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:text-slate-100 dark:group-hover:text-white flex items-center gap-2"><i className="ph ph-star text-slate-400"></i> Star Alliance</span>
                </div>
              ...
              <label className="flex justify-between items-center cursor-pointer group">
                <div className="flex items-center gap-3">
                  <input type="checkbox" className="w-4 h-4 rounded border-slate-300 accent-green-600" />
                  <span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:text-slate-100 dark:group-hover:text-white flex items-center gap-2"><i className="ph ph-cloud text-slate-400"></i> SkyTeam</span>
                </div>
              ...
              <label className="flex justify-between items-center cursor-pointer group">
                <div className="flex items-center gap-3">
                  <input type="checkbox" className="w-4 h-4 rounded border-slate-300 accent-green-600" />
                  <span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:text-slate-100 dark:group-hover:text-white flex items-center gap-2"><i className="ph ph-planet text-slate-400"></i> Oneworld</span>
                </div>
        ...
        <section className="lg:col-span-9 w-full min-w-0">
          ...
          <div className="flex border border-t-0 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 mb-4 shadow-sm text-sm" role="tablist">
            ...
            <button data-price-alert-btn className="hidden md:flex flex-1 py-3 text-center border-b-2 border-transparent text-green-600 hover:bg-green-50 dark:hover:bg-green-900/40 font-bold border-l border-slate-100 dark:border-slate-700 items-center justify-center gap-1.5 transition-colors">
          ...
          <div className="space-y-3" data-results-list>
            <div className="bg-white dark:bg-slate-800 p-6 border border-slate-200 dark:border-slate-700 shadow-sm animate-pulse">
              <div className="h-4 bg-slate-100 dark:bg-slate-700 rounded w-1/4 mb-4"></div>
              <div className="h-12 bg-slate-100 dark:bg-slate-700 rounded w-full"></div>
            </div>
            <div className="bg-white dark:bg-slate-800 p-6 border border-slate-200 dark:border-slate-700 shadow-sm animate-pulse">
              <div className="h-4 bg-slate-100 dark:bg-slate-700 rounded w-1/4 mb-4"></div>
              <div className="h-12 bg-slate-100 dark:bg-slate-700 rounded w-full"></div>
    ...
    <div id="price-alert-modal" className="fixed inset-0 bg-slate-900/60 z-[100] hidden items-center justify-center p-4 backdrop-blur-sm transition-opacity opacity-0">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden transform scale-95 transition-transform duration-200" id="price-alert-modal-content">
        <button id="close-price-alert" type="button" className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center text-slate-400 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300 rounded-full transition-colors z-10">
          <i className="ph-bold ph-x"></i>
        </button>
        
        {/* Header Illustration Area */}
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-6 flex justify-between items-start border-b border-slate-100 dark:border-slate-700 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-green-200 dark:bg-green-800/30 rounded-full blur-3xl opacity-40 -translate-y-1/2 translate-x-1/2"></div>
          <div className="relative z-10">
            <h2 className="text-xl font-extrabold text-slate-900 dark:text-slate-100 mb-2">Price alerts</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 max-w-[200px]">Set departure time to find your ideal flights!</p>
          </div>
          <div className="relative w-20 h-20 shrink-0 z-10">
            <div className="absolute inset-0 bg-white dark:bg-slate-800 rounded-full shadow-sm flex items-center justify-center border border-white dark:border-slate-700">
               <i className="ph-fill ph-airplane-tilt text-4xl text-green-500"></i>
               <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center shadow-sm">
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Flexible Dates */}
          <div>
             <label className="text-sm font-bold text-slate-800 dark:text-slate-200 block mb-2">Flexible dates</label>
             <div className="border border-slate-200 dark:border-slate-700 hover:border-green-500 rounded-lg p-3 text-sm font-semibold text-slate-900 dark:text-slate-100 bg-white dark:bg-slate-800 shadow-sm cursor-pointer transition-colors" data-alert-date>
                Tue, May 5
             </div>
          </div>
          ...
          <div>
             ...
             <div className="mt-6 mb-2 relative px-4">
                <div className="relative h-4 flex items-center">
                  ...
                  />
                  <div className="absolute top-1/2 -translate-y-1/2 w-6 h-6 bg-white dark:bg-slate-800 border-2 border-yellow-400 rounded-full shadow flex items-center justify-center z-10 pointer-events-none transition-transform" data-alert-slider-thumb style={{ left: '75%', transform: 'translate(-50%, -50%)' }}>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
               <div className="flex items-center gap-1.5">
                 <span className="text-sm font-bold text-slate-900 dark:text-slate-100">Receive alerts by email</span>
                 <i className="ph ph-info text-slate-400 text-xs"></i>
               </div>
               <span className="text-[10px] font-semibold text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 px-2 py-0.5 rounded-full flex items-center gap-1">
            ...
            <div className="flex flex-col gap-1.5 mt-2">
               <input 
                 ...
                 className="w-full border border-slate-300 dark:border-slate-600 bg-transparent rounded-lg px-3 py-2 text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:border-green-600 focus:ring-1 focus:ring-green-600 transition-colors"
               />
          ...
          <label className="flex items-center gap-2.5 cursor-pointer mt-1 group w-max">
            ...
            <span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:text-slate-100 dark:group-hover:text-white">Nonstop only</span>
          </label>
    ...
    <div id="date-picker-modal" className="fixed inset-0 bg-slate-900/60 z-[110] hidden items-center justify-center p-4 backdrop-blur-sm transition-opacity opacity-0">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-[700px] overflow-hidden transform scale-95 transition-transform duration-200" id="date-picker-modal-content">
        <div className="p-5 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center">
          <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">Select flexible departure dates</h2>
          <button id="close-date-picker" type="button" className="w-8 h-8 flex items-center justify-center text-slate-400 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300 rounded-full transition-colors">
            <i className="ph-bold ph-x"></i>
          </button>
        </div>
        ...
        <div className="p-6 relative">
          ...
          <div className="mt-8 flex justify-between items-end pt-4 border-t border-slate-100 dark:border-slate-700">
            <div className="text-sm text-slate-500 dark:text-slate-400">
               <span className="font-bold text-slate-900 dark:text-slate-100 block mb-0.5" id="dp-selected-text">Depart: -</span>
